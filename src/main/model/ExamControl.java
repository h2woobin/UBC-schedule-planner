 ...
 * EFFECTS: remove all imformation what user wants to remove. Check if the subject that user wants to delete
 *         is in the exam list or not. If it's in it, it will be removed and return true. Otherwise, mothod will give false. 
 */
